...
import { RefreshCcw, Clock, CreditCard, Ban, Mail, ArrowRight, FileText, CheckCircle2, AlertCircle, XCircle, PieChart, Edit3, Printer, Shield } from "lucide-react";
  ...
  const sections = [
    {
      ...
      title: t("refund.pillars.p1_title"),
      content: t("refund.pillars.p1_desc"),
    ...
    },
    {
      ...
      title: t("refund.pillars.p2_title"),
      content: t("refund.pillars.p2_desc"),
    ...
    },
    {
      ...
      title: t("refund.pillars.p3_title"),
      content: t("refund.pillars.p3_desc"),
    ...
    },
    {
      ...
      title: t("refund.pillars.p4_title"),
      content: t("refund.pillars.p4_desc"),
  ...
  const refundDetails = [
    {
      ...
      title: t("refund.details.d1_title"),
      desc: t("refund.details.d1_desc")
    },
    {
      icon: <CheckCircle2 className="w-5 h-5" />,
      title: t("refund.details.d2_title"),
      desc: t("refund.details.d2_desc")
    },
    {
      icon: <Ban className="w-5 h-5" />,
      title: t("refund.details.d3_title"),
      desc: t("refund.details.d3_desc")
    },
    {
      icon: <PieChart className="w-5 h-5" />,
      title: t("refund.details.d4_title"),
      desc: t("refund.details.d4_desc")
    },
    {
      icon: <Edit3 className="w-5 h-5" />,
      title: t("refund.details.d5_title"),
      desc: t("refund.details.d5_desc")
    }
  ];
    ...
    <div className="bg-white min-h-screen pt-[120px] pb-24">
      ...
      <section className="relative px-4 sm:px-6 mb-16 sm:mb-24 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            {t("refund.title")} <span className="text-primary">{t("refund.titleHighlight")}</span> {t("refund.policy")}
          </motion.h1>
          <motion.p
            initial="hidden"
            animate="visible"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {sections.map((sec, i) => (
            <motion.div
              ...
              className={`p-10 rounded-[2.5rem] bg-white border border-slate-100 relative group overflow-hidden transition-all duration-500 shadow-sm ${sec.borderHover} ${sec.shadowHover}`}
            >
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-12 pb-8 border-b border-slate-100">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-black text-dark tracking-tight">{t("refund.details.fullDoc")}</h2>
                  <p className="text-slate-500 text-sm font-medium mt-1">{t("refund.details.docId")}</p>
                </div>
              </div>
              <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 font-bold text-sm hover:bg-white hover:border-primary/30 hover:text-primary transition-all shadow-sm">
                <Printer className="w-4 h-4" /> {t("refund.details.print")}
              </button>
            </div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="mt-20 p-8 sm:p-10 rounded-[2rem] bg-linear-to-br from-amber-50 to-orange-50 border border-amber-100/50 flex flex-col sm:flex-row items-center gap-8 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/40 blur-3xl rounded-full translate-x-10 -translate-y-10" />
              <div className="w-20 h-20 rounded-[1.5rem] bg-white shadow-xl shadow-amber-900/5 flex items-center justify-center shrink-0 relative z-10">
                <AlertCircle className="w-10 h-10 text-amber-600" />
              </div>
              <div className="relative z-10 text-center sm:text-left">
                <h4 className="text-amber-900 font-black text-xl mb-2">{t("refund.note.title")}</h4>
                <p className="text-amber-700/80 text-base leading-relaxed font-medium">
                  {t("refund.note.desc")}
                </p>
                <div className="mt-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 border border-amber-200 text-[10px] font-black uppercase tracking-wider text-amber-600">
                  <Shield className="w-3 h-3" /> {t("refund.note.badge")}
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="max-w-[800px] mx-auto px-4 sm:px-6 mt-24 text-center">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-extrabold text-white mb-4">{t("refund.help.title")}</h2>
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-white font-bold rounded-2xl hover:bg-primary-dark transition-all">
              {t("refund.help.cta")} <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
        </motion.div>
