...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "type",
            sa.Enum("home_collection", "lab_visit", name="bookingtype"),
            nullable=False,
        ),
    )
    op.add_column(
    ...
    op.add_column(
        ...
        sa.Column(
            "plan",
            sa.Enum("starter", "basic", "advanced", "premium", name="subscriptionplan"),
            nullable=True,
        ),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            "shift",
            sa.Enum("morning", "evening", "full_day", name="shifttype"),
            nullable=False,
        ),
    )
    op.add_column(
        ...
        sa.Column(
            "status",
            sa.Enum("on_duty", "idle", "off_duty", "on_break", name="technicianstatus"),
            nullable=True,
        ),
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "lab_tests",
        sa.Column("discount_price", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "lab_tests",
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            postgresql.ENUM("low", "medium", "high", "critical", name="ticketpriority"),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
