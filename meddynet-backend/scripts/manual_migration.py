...
def migrate():
    ...
    with engine.connect() as conn:
        ...
        except Exception as e: print(f"Users image column: {e}")
        
        try:
            conn.execute(text("ALTER TABLE labs ADD COLUMN image_url VARCHAR(500);"))
            print("Added image_url to labs")
        except Exception as e: print(f"Labs image column: {e}")
        ...
        except Exception as e: print(f"Technicians image column: {e}")
        ...
        except Exception as e: print(f"Drop Table: {e}")
