...
class AnalyticsService:
    async def log_conversion(self, booking_id: str, user_id: str, amount: int, lab_id: str):
        ...
        await mongo_service.track_metric(name="total_booking_revenue", value=amount, tags={"lab_id": lab_id})
    ...
    async def log_payout_success(self, lab_id: str, amount: int, payout_id: str):
        ...
        await mongo_service.track_metric(name="total_payout_volume", value=amount, tags={"lab_id": lab_id})
    ...
    async def log_report_generation(self, booking_id: str, lab_id: str, report_url: str):
