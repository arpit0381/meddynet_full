...
class NotificationService:
    ...
    async def send_booking_confirmation(self, phone: str, booking_id: str):
        ...
        await mongo_service.log_event(
            ...
            context={"phone": phone, "type": "sms_confirmation", "booking_id": booking_id}
        )
        return res
    ...
    async def send_report_link(self, phone: str, booking_id: str, link: str):
        ...
        await mongo_service.log_event(
            ...
            context={"phone": phone, "type": "report_link", "booking_id": booking_id, "url": link}
        )
        return res
    ...
    async def send_whatsapp_booking_confirmation(self, phone: str, booking_id: str, lab_name: str, date: str, time: str):
        """
...
class WhatsAppBusinessProvider(NotificationProvider):
    ...
    async def send_template(self, phone: str, template_name: str, language: str = "en", components: list = None) -> bool:
        """
